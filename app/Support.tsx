      ...
      >
        <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-6">
          ...
          <div className="md:flex-1 relative w-full">
            ...
            <button
              type="submit"
              className="absolute right-1 top-1 h-[36px] w-[36px] flex items-center justify-center bg-white text-amber-500 rounded-ios-sm shadow-sm transition-all duration-200 hover:bg-gray-50 active:scale-90"
              aria-label="Send"
            >
              <svg className="w-5 h-5 -ml-0.5 mt-0.5" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
