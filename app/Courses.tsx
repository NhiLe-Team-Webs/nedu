  ...
  const slides: CourseSlide[] = React.useMemo(
    () => [
      ...
      },
      {
        ...
        image: thirtyDayPreview.desktop || thirtyDayCourse?.heroImage || "/images/programs/thu-thach-30-ngay-desktop.png",
        imageMobile: thirtyDayPreview.mobile || thirtyDayCourse?.mobileImage || "/images/programs/thu-thach-30-ngay-mobile.png",
