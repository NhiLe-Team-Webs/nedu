            ...
            >
              ...
              <div className="p-6">
                ...
                <p className="text-sm text-gray-600 mb-2 flex items-center gap-2">
                  <svg xmlns="http://www.w3.org/2000/svg" height="20px" viewBox="0 -960 960 960" width="20px" fill="#F7B50C" className="flex-shrink-0">
                ...
                <div className="mt-4">
                  <Button
                    ...
                    className="w-full flex items-center justify-center gap-2 bg-transparent text-black border-2 border-black hover:bg-gray-200 hover:border-gray-400 transition-all duration-300 ease-in-out font-medium rounded-[50px]"
                  >
