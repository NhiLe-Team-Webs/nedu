  ...
  return (
    <div className="min-h-screen bg-gray-50 py-12">
      <div className="container mx-auto px-4">
        <h1 className="text-4xl md:text-6xl font-extrabold text-center mb-4 text-primary">
                ...
                <div className="p-6 flex flex-col gap-2">
                  <div className="flex flex-wrap gap-2">
                    {course.tags.map((tag, index) => (
                      <span
                        key={index}
                        className="text-base bg-primary/10 text-primary px-3 py-1 rounded-full font-semibold"
                      >
                        {tag}
                      </span>
                    ))}
                  ...
                  <div className="flex flex-row gap-3 items-center">
                    <BookOpen className="inline-block w-6 h-6 text-[#F7B50C]" />
                  ...
                  <div className="flex flex-row gap-3 items-center">
                    <User className="inline-block w-6 h-6 text-[#F7B50C]" />
                    <p className="text-sm text-gray-600">
                      Người dẫn đường:{" "}
