  ...
  return (
    <div className={`fixed bottom-0 left-0 right-0 z-50 shadow-[0_-4px_20px_rgba(0,0,0,0.15)] transition-transform duration-300 ${
      ...
      <div className="bg-[#4A4A4A] opacity-90 text-white px-3 py-3 md:px-4 md:py-4">
        <div className="max-w-7xl mx-auto flex flex-col md:flex-row items-center md:justify-between gap-3 md:gap-4">
          {/* Left Section - Text and Countdown */}
          <div className="flex flex-col md:flex-row items-center gap-3 md:gap-8 w-full md:flex-1">
            {/* Title with Icon */}
            <div className="flex flex-col items-center md:items-start shrink-0 w-full md:w-auto">
              ...
              <div className="text-xs md:text-sm text-gray-300 md:pl-12">
                08/12/2025 - 08/01/2026
              </div>
            </div>

            {/* Countdown Timer */}
            <div className="flex gap-2 md:gap-3 justify-center w-full md:w-auto">
          ...
          <div className="flex flex-col w-full md:w-auto gap-2">
            <Link href="/program-offline/la-chinh-minh" className="w-full md:w-auto bg-red-600 hover:bg-red-700 text-white font-bold py-2.5 md:py-3 lg:py-4 px-6 md:px-8 rounded-lg shadow-lg hover:shadow-xl transition transform active:scale-95 whitespace-nowrap flex items-center justify-center gap-2 text-base md:text-lg">
              <span>Đăng ký ưu đãi 17%</span>
