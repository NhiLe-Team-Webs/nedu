      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6 lg:gap-8 w-full max-w-4xl sm:max-w-5xl lg:max-w-6xl px-4 sm:px-0">
        {items.map((item, index) => {
          ...
          return (
            <div
              key={index}
              className="flex flex-col items-center p-4 sm:p-6 bg-white shadow-ios-card rounded-ios-lg border-2 border-gray-400 transition-all duration-300 hover:shadow-ios-float hover:scale-[1.02]"
            >
